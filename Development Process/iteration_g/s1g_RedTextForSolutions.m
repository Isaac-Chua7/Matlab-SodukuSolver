...
% %sudoku puzzle solving program
%this is the seventh iteration of my sudoku puzzle solving program. 
%this program can solve simple sudoku puzzles that only
%require constraint propagation to be solved. A figure window in which the 
% solved sudoku is displayed graphically, which is much nicer to read than 
%the command window. This iteration makes note of what number were inputted
%by the user and what number were added by the computer so that they can be
%displayed in different colours at the end, black for user input, red for
%computer.
