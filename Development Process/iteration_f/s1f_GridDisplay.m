...
% %sudoku puzzle solving program
%this is the sixth iteration of my sudoku puzzle solving program. 
%this program can solve simple sudoku puzzles that only
%require constraint propagation to be solved. 
%this iteration adds a figure window in which the solved sudoku is
%displayed graphically, which is much nicer to read than the command
%window.
